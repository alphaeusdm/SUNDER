...
class LLMTune():
    ...
    def load_model(self, task_name="NER", model_name='llama', model_size=8, data_size=None):
        ...
        self.save_path = f"models/{task_name}/{model_name}-{model_size}B-instruction-unmask-layer" if not data_size else f"models/{task_name}/{model_name}-{model_size}B-instruction-tuned-{data_size}"
