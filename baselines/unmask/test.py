...
def load_model(task, model_name, model_size, tuned=False, data_size=None, instruction_tune=False):
    ...
    model_class = {
        'mistral': modeling_mistral.UnmaskingMistralForCausalLM,
        'llama': modeling_llama.UnmaskingLlamaForCausalLM,
        'qwen': modeling_qwen.UnmaskingQwen2ForCausalLM,
        'qwen3': modeling_qwen3.UnmaskingQwen3ForCausalLM,
    }
    if tuned:
