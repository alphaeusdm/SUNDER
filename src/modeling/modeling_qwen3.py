...
@auto_docstring
class SelectiveUnmaskingQwen3Model(Qwen3PreTrainedModel):
...
@auto_docstring
class SelectiveUnmaskingQwen3ForCausalLM(Qwen3PreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config):
        super().__init__(config)
        self.model = SelectiveUnmaskingQwen3Model(config)
        self.vocab_size = config.vocab_size
