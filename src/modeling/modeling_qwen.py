...
@auto_docstring
class SelectiveUnmaskingQwen2Model(Qwen2PreTrainedModel):
...
@auto_docstring
class SelectiveUnmaskingQwen2ForCausalLM(Qwen2PreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config):
        super().__init__(config)
        self.model = SelectiveUnmaskingQwen2Model(config)
        self.vocab_size = config.vocab_size
